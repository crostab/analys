...
const tableToSamples = (table, fields) => {
  ...
  return (fields === null || fields === void 0 ? void 0 : fields.length) ? selectSamplesByHead.call((_table = table, matchSlice(_table)), fields) : keyedColumnsToSamples.call((_table2 = table, matchSlice(_table2)));
};
