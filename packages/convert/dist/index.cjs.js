...
const tableToSamples = (table, fields) => {
  ...
  return (fields === null || fields === void 0 ? void 0 : fields.length) ? keyedColumns.selectSamplesByHead.call((_table = table, tableInit.matchSlice(_table)), fields) : keyedColumns.keyedColumnsToSamples.call((_table2 = table, tableInit.matchSlice(_table2)));
};
